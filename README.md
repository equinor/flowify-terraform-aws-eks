...
|:-----------------------------------------------|:--------------:|-------------------------------------------------|----------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `region`                                       |    `string`    | `us-west-1`                                     | `no`     | `The region where AWS operations will take place`                                                                                                                                                                                            |
| `env_name`                                     |    `string`    | `usw101`                                        | `no`     | `Environment name to be used on all the resources as identifier`                                                                                                                                                                             |
...
| `cluster_name`                                 |    `string`    | `atlas`                                         | `no`     | `Name of the EKS cluster. Also used as a prefix in names of related resources`                                                                                                                                                               |
